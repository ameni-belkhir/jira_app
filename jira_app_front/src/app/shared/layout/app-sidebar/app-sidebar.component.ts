...
export class AppSidebarComponent {
  ...
  // TODO: RÉACTIVER — Ajouter Messages, Analytics, Chat ici quand les pages seront développées
  ...
  // TODO: RÉACTIVER — Décommenter pour ajouter les éléments Messages et Analytics dans mainNavItems
  /*
  {
    icon: `...`,
    name: "Messages",
  ...
  */
  ...
  // TODO: RÉACTIVER — Décommenter pour ajouter le Backlog dynamique dans le menu
  /*
  get backlogNavItem(): NavItem | null {
  ...
  */
  ...
  /** Get all visible nav items (main items only) */
  get navItems(): NavItem[] {
